const templateEmailView = ({name = '', email = '', productName = ''}) => `<!DOCTYPE html>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
   ...
   <tr>
      <td>
          <a style="width: 150px; height: 150px; text-align:center; display: block; margin: 15px auto 30px; overflow: visible; border-radius: 8px; background: #ffffff;">

              <img style="width: 100%; height: 100%; border-radius: 8px; object-fit: contain;" src="https://storage.googleapis.com/outing-vms-app.appspot.com/welcome_135ef5a24b/welcome_135ef5a24b.jpg" alt="welcome">
  ...
  <tr>
      <td>
          <h3 style="text-align: center; font-family: 'Open Sans', sans-serif;">SELAMAT DATANG</h3>
      </td>
  </tr>
